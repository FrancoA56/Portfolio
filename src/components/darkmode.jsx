    ...
    <div className="flex mr-8">
      ...
      {isDarkMode ? (
        <button
          ...
          className="h-10 w-auto whitespace-nowrap bg-transparent px-3 py-2 text-sm font-normal text-gray-700 focus:bg-transparent focus:outline-none active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-100 dark:hover:bg-transparent"
          href="#"
          data-theme="light"
